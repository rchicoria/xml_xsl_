...
<xsl:template match="/">
  ...
  <body style="background: #fff7c2">
    ...
    <xsl:for-each select="b:list/b:ebook">
      <div style="display: inline; width: 600px; height: 340px; float: left; word-wrap: break-word; background-color: #ffc37d; border: 1px solid #cc904a; margin: 20px; padding: 10px; border-radius: 10px; box-shadow: 5px 2px 10px #999;">
            ...
            <table width="100%">
            	<tr>
	          	...
	          	<tr>
	          		...
	          		<td><xsl:value-of select="b:classificacao"/></td>
	          	</tr>
	          	<tr>
	          		<td><b>Formato</b></td>
